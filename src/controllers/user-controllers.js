...
const signUp=async (req,res)=>{
    ...
    try{
        ...
        res.clearCookie("auth_token", {httpOnly:true, signed:true,path:"/",domain:"localhost"})
    ...
    res.cookie("auth_token",token,{path:'/',httpOnly:true, signed:true,expires:expiretime,domain:"localhost"})
